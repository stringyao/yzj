...
FULL_OUTFILE = 'xgb_parallel_sub.csv'
...
dvalid = xgb.DMatrix(validation_df[predictors].values, validation_df[target].values)
...
model = xgb.train(params, dtrain, num_boost_round, watchlist, maximize=True, early_stopping_rounds = early_stopping_rounds, verbose_eval=5)

OPT_ROUNDS = model.best_iteration
